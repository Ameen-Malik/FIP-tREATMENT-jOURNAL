...
['nameSheet','protoSheet','editSheet','catSwitcherSheet','onboardingSheet','cloudLinkSheet','shareCardSheet','shareSheet','bloodReportsSheet','batchLogSheet','confirmSheet'].forEach(id => {
